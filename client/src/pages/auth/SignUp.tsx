...
const SignUp: React.FC = () => {
  ...
  useEffect(() => {
    if (isSignedIn) {
      ...
      const redirectUrl = storedRole === 'doctor' ? '/doctor/setup-profile' : '/patient/setup-profile';
  ...
  const getRedirectUrl = () => {
    return role === 'doctor' ? '/doctor/setup-profile' : '/patient/setup-profile';
  };

  const getTitle = () => {
    return role === 'doctor' ? 'Doctor Sign Up' : 'Patient Sign Up';
  };

  const getSubtitle = () => {
    return role === 'doctor' ? 'Create your medical practice account' : 'Create your health management account';
  };
